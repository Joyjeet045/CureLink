...
SECRET_KEY = 'django-insecure-y#^ep+^=ju!n$%ne$yz-eyu=z5iq0og5)4d@ipe$*0nru6ji*r'
...
WSGI_APPLICATION = 'doctors_app.wsgi.application'

ASGI_APPLICATION = 'doctors_app.asgi.application'
